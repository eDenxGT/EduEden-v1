          ...
          <div className="mb-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                <li>
                  <Link to="/student/courses" className="text-gray-500 hover:text-gray-700">Courses</Link>
                </li>
                <li>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-2xl font-semibold mb-8">Shopping Cart ({courses?.length || 0})</h1>
                  ...
                  <div key={course.course_id}>
                    <div className="py-6 grid grid-cols-[1fr,auto,auto] gap-4 items-center">
                      ...
                      <div className="text-center px-4">
                        <div className="text-lg font-semibold text-orange-500">₹{course.price.toFixed(2)}</div>
                      </div>
                      <Button 
                    ...
                    {index < courses.length - 1 && <hr className="border-t border-gray-200" />}
                  </div>
                ))}
              </div>
            </Card>
