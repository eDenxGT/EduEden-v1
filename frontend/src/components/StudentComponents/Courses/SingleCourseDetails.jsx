...
import { Star, Clock, Users, Globe, Play, Heart, FileText, ChevronDown, Link, User2Icon, CopyIcon, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Navigation link */}
        <RouterLink to="/student/courses" className=" text-gray-500 hover:text-gray-900 mb-4">
          <span>Courses / </span> 
        </RouterLink>
          <span className="text-gray-500 hover:text-gray-700 mb-4">{course?.title}</span>
              ...
              <div className="space-y-6">
                ...
                {isCourseInCart ? 
                  <Button
                    ...
                    onClick={()=>navigate(`/student/cart/${user_id}`)}
                  /> : 
                  <Button
                    text="Add To Cart"
                    className="w-full bg-[#FF5722] font-semibold  hover:bg-[#F4511E] text-white py-3"
                ...
                <p className="text-sm text-gray-500 italic">
                  Note: all course have 30-days money-back
                  guarantee
                </p>
