  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? "dark bg-gray-900" : "bg-gradient-to-b from-gray-50 to-gray-100"}`}>
      ...
      <main className="mt-16">
        {/* Hero Section */}
        <section className={`${isDarkMode ? "bg-gray-800" : "bg-gradient-to-r from-[#FFEEE8] to-[#FFF6F0]"}`}>
          <div className="mx-auto flex flex-col md:flex-row justify-center items-center min-h-screen">
            <div className="md:w-1/2 flex justify-center items-center ">
              <div className="flex-col space-y-6 justify-center items-start">
                <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold ${isDarkMode ? "text-white" : "text-gray-800"} leading-tight`}>
                  Master <span className="text-[#FF5722]">Code,</span>
                  <br />
                  Step by Step
                </h1>
                <p className={`text-lg md:text-xl ${isDarkMode ? "text-gray-300" : "text-gray-600"} max-w-md`}>
                  Skip the &#34;what should I learn next?&#34; confusion. Follow our structured paths,
                  build awesome projects, and get expert help whenever you need it.
                </p>
                <Button
                  text="Become A Developer"
                  className={`w-auto max-w-fit px-6 py-3 ${
                    isDarkMode
                      ? "bg-blue-600 hover:bg-blue-700"
                      : "bg-gradient-to-r from-[#ff6b35] to-[#ff8c35] hover:from-[#ff8c35] hover:to-[#ff6b35]"
                  } text-white rounded-full text-lg font-semibold transition-colors duration-300`}
                />
              </div>
            </div>
        ...
        <section className={`container mx-auto my-20 xl:max-w-6xl px-12 py-16 rounded-md ${isDarkMode ? "bg-gray-800" : ""}`}>
          <div className="flex justify-between items-center mb-12">
            <h2 className={`text-3xl md:text-4xl font-bold ${isDarkMode ? "text-white" : "text-gray-800"}`}>
              Browse Categories
            </h2>
            <button className={`${isDarkMode ? "text-blue-400 hover:text-blue-300" : "text-[#ff6b35] hover:text-[#ff8c35]"} flex items-center text-lg font-semibold transition-colors duration-300`}>
              See more
              <ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" />
            </button>
          </div>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 sm:grid-cols-3 lg:grid-cols-4">
            {categories.map((category) => (
              <Card
                key={category.name}
                className={`p-4 md:p-6 ${isDarkMode ? "bg-gray-700 hover:bg-gray-600" : "bg-white hover:bg-gray-50"} transition-all duration-300 cursor-pointer rounded-xl`}
              >
                <div className="flex flex-col items-center text-center gap-4">
                  <div className={`${isDarkMode ? "bg-gray-600" : "bg-gray-100"} shadow-lg p-4 rounded-full`}>
                    {category.icon}
                  </div>
                  <div>
          ...
          <div className="container xl:max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {courses.slice(0, 3).map((course) => (
                <Card
                  key={course.title}
                  className={`overflow-hidden rounded-xl ${isDarkMode ? "bg-gray-800" : "bg-white"} shadow-lg hover:shadow-xl transition-all duration-300`}
                >
                  <img
                    alt={course.title}
                  ...
                  />
                  <div className="p-6">
                    <h3 className={`font-bold text-xl min-h-[3.5rem] mb-2 ${isDarkMode ? "text-white" : "text-gray-800"}`}>
                      {course.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <Users className={`h-5 w-5 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`} />
                      <span className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
        ...
        <section className={`container mx-auto xl:max-w-6xl px-4 py-16 ${isDarkMode ? "bg-gray-800" : ""}`}>
          <div className="flex justify-between items-center mb-12">
            <h2 className={`text-3xl md:text-4xl font-bold ${isDarkMode ? "text-white" : "text-gray-800"}`}>
              ...
              >
                ...
                <div className="flex-1 p-6">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                    <div>
                      <h3 className={`font-bold text-xl mb-2 ${isDarkMode ? "text-white" : "text-gray-800"}`}>
                        {event.title}
                      </h3>
                      ...
                      <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
                        <Users className="inline-block mr-2" aria-hidden="true" />
        ...
        <section className={`${isDarkMode ? "bg-gray-900" : "bg-gradient-to-r from-[#FFEEE8] to-[#FFF6F0]"} py-16`}>
          <div className="container mx-auto xl:max-w-6xl px-4">
            <div className="grid md:grid-cols-2 gap-12">
              <Card className={`${isDarkMode ? "bg-gray-800" : "bg-white"} flex flex-col justify-evenly p-8 px-14 rounded-xl shadow-lg`}>
                <div>
                  <h2 className={`text-3xl font-bold ${isDarkMode ? "text-blue-400" : "text-[#ff6b35]"} mb-4`}>
                    Become a Mentor
                  </h2>
              ...
              <div className="space-y-8">
                <h3 className={`text-3xl font-bold ${isDarkMode ? "text-white" : "text-gray-800"} mb-6`}>
                  Your teaching & earning steps
                </h3>
                {teachingSteps.map((step, index) => (
                  <div key={index} className="flex gap-6 items-start">
                    <div className={`flex h-12 w-12 items-center justify-center rounded-full ${isDarkMode ? "bg-blue-600" : "bg-[#ff6b35]"} text-white text-xl font-bold`}>
                      {index + 1}
                    </div>
                    <div>
        ...
        <section className={`${isDarkMode ? "bg-gray-900" : "bg-gradient-to-b from-white to-[#FFEEE8]"} py-16`}>
          <div className="container mx-auto xl:max-w-6xl px-4">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDarkMode ? "text-white" : "text-gray-800"} animate-fade-in`}>
              Learning Resources
            </h2>
              ...
              {platforms.map((platform, index) => (
                ...
                >
                  <img
                    ...
                    className={`object-contain ${platform.height} ${isDarkMode ? "filter invert" : ""}`}
                  />
                </div>
              ))}
            </div>
