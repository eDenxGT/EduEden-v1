...
import { Lock, Eye, EyeOff, ArrowRight, Mail, AlertCircle } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      } border focus:outline-none focus:ring-2 focus:ring-opacity-50 ${errors.email ? 'border-red-500' : ''}`}
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-12 py-2 rounded-lg ${
                        isDarkMode 
                          ? 'bg-gray-700 text-white border-gray-600 focus:border-blue-400' 
                          : 'bg-white text-gray-900 border-gray-300 focus:border-blue-600'
                      } border focus:outline-none focus:ring-2 focus:ring-opacity-50 ${errors.password ? 'border-red-500' : ''}`}
